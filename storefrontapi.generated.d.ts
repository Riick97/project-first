...
export type HomepageCriticalDataQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type HomepageCriticalDataQuery = {
  collections: {
    nodes: Array<
  ...
  >;
  sleepChill?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      image?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText' | 'width' | 'height'>
      >;
  ...
  >;
  productivityGlow?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      image?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText' | 'width' | 'height'>
      >;
...
export type RecommendedProductFragmentFragment = Pick<
  StorefrontAPI.Product,
...
export type TestimonialFragmentFragment = Pick<
...
export type ShopPoliciesQuery = {
  shop: {
    ...
    subscriptionPolicy?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.ShopPolicyWithDefault, 'id' | 'title' | 'body'>
    >;
  };
};
...
export type OtherProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  collectionHandle?: StorefrontAPI.InputMaybe<
    StorefrontAPI.Scalars['String']['input']
  >;
  first?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
}>;
    ...
    Pick<StorefrontAPI.Collection, 'title' | 'handle'> & {
      products: {
        nodes: Array<
          Pick<
            StorefrontAPI.Product,
            'id' | 'title' | 'handle' | 'availableForSale' | 'vendor' | 'tags'
          > & {
            featuredImage?: StorefrontAPI.Maybe<
              Pick<
                StorefrontAPI.Image,
...
interface GeneratedQueryTypes {
  ...
  '#graphql  \n  fragment FeaturedCollection on Collection {\n    id\n    title\n    handle\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n  }\n  fragment FeaturedProducts on Product {\n    id\n    title\n    handle\n    tags\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    availableForSale\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    compareAtPriceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    images(first: 1) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n\n    variants(first: 1) {\n      nodes {\n        id\n        availableForSale\n        compareAtPrice {\n          amount\n          currencyCode\n        }\n        price {\n          amount\n          currencyCode\n        }\n        selectedOptions {\n          name\n          value\n        }\n      }\n    }\n\n    selectedOrFirstAvailableVariant {\n      id\n      availableForSale\n      compareAtPrice {\n        amount\n        currencyCode\n      }\n      price {\n        amount\n        currencyCode\n      }\n      selectedOptions {\n        name\n        value\n      }\n    }\n    options {\n      name\n      values\n    }\n  }\n  \n  query HomepageCriticalData($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    collections(first: 1, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...FeaturedCollection\n      }\n    }\n    products(first: 4, sortKey: CREATED_AT, reverse: true) {\n      nodes {\n        ...FeaturedProducts\n      }\n    }\n    newArrivals: collection(handle: "new-arrivals") {\n      ...FeaturedCollection\n    }\n    roomVibes: collection(handle: "room-vibes") {\n      ...FeaturedCollection\n    }\n    sleepChill: collection(handle: "sleep-chill") {\n      ...FeaturedCollection\n    }\n    productivityGlow: collection(handle: "productivity-glow") {\n      ...FeaturedCollection\n    }\n  }\n': {
    return: HomepageCriticalDataQuery;
    variables: HomepageCriticalDataQueryVariables;
  };
